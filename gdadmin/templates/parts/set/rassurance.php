        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <form class="row" method="post" enctype="multipart/form-data">
                    <?= Tools::generateInput("text", "Nom", "title", @$el->{"title"._PREFIX_LANG_}, "col-6"); ?>
                    <?= Tools::generateInput("text", "Chiffre", "chiffre", @$el->{"chiffre"._PREFIX_LANG_}, "col-6"); ?>

                    <?= Tools::generateInput("text", "Logo", "logo", @$el->logo, 'col-12'); ?>
