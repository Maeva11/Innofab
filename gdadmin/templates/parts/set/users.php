    ...
    <div class="card-header card-header-tabs card-header-primary">
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                <span class="nav-tabs-title">Utilisateurs</span>
    ...
    <div class="card-body">
        <div class="tab-content">
            <div class="tab-pane active">
                ...
                <?= Tools::generateInput("text", "Prenom", "prenom", @$el->{"prenom"._PREFIX_LANG_}, "col-6"); ?>
                <?= Tools::generateInput("text", "Mot de passe", "password", @$el->{"password"._PREFIX_LANG_}, "col-6"); ?>
                <?= Tools::generateInput("text", "Email", "email", @$el->{"email"._PREFIX_LANG_}, "col-6"); ?>
                <?= Tools::generateInput("text", "Telephone", "phone", @$el->{"phone"._PREFIX_LANG_}, "col-6"); ?>
                <?= Tools::generateInput("text", "Adresse", "address", @$el->{"address"._PREFIX_LANG_}, "col-6"); ?>
                <?= Tools::generateInput("radio", "Adherent", "adherent", @$el->active, 'col-4', '', ['oui'=> 1, 'non'=>0]); ?>
