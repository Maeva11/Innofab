    ...
    <div class="card-header card-header-tabs card-header-primary">
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                <span class="nav-tabs-title">Membres</span>
                ...
                <table class="table">
                    ...
                    if(!empty($data['datas'])){
                        foreach($data['datas'] as $el){?>
                            <tr>
                                <td><img style="width: 80px; height; 80px; object-fit: cover" src="<?= @$el->logo ?>" alt=""></td>
                                <td><?=substr(@$el->name , 0, 50); ?></td>
                        ...
                        <tr>
                            <td class="text-center h4">Aucun membre</td>
                        </tr>
                    <?php }?>
                    </tbody>
                </table>
