        ...
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                ...
                <ul class="nav nav-tabs float-right">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= $_SERVER['REQUEST_URI'] ?>/set" ><i class="material-icons">code</i> Nouvel utilisateur</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    if(!empty($data['datas'])){
                        foreach($data['datas'] as $el){?>
                            <tr>
                                ...
                                <td><?=substr(@$el->prenom , 0, 50); ?></td>
                                <td><?=substr(@$el->adherent , 0, 50); ?></td>
                        ...
                        <tr>
                            <td class="text-center h4">Aucun utilisateur</td>
                        </tr>
                    <?php }?>
                    </tbody>
                </table>
