<style>
    ...
    .path-2 {
        ...
        transition: 1.2s linear 3.2s;
    }

    .path-3 {
        stroke-dasharray: 100 1000;
        stroke-dashoffset: 101;
        transition: 1s linear 4.5s;
    }

    .path-4 {
        stroke-width: 0;
        transition: 0.1s linear 5.5s;
    }
</style>
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row console justify-content-around mt-5">
            <a href="<?= ADMIN_URL ?>crud/priseRendezvous" class="col-3 items">
                <i class=" item-color far fa-clock"></i>
                <p class="title-items"> Rendez-vous</p>
            </a>
            <a href="<?= ADMIN_URL ?>crud/reservation" class="col-3 items">
                <i class=" item-color far fa-calendar-check"></i>
                <p class="title-items">Réservation</p>
            </a>
            <a href="<?= ADMIN_URL ?>crud/factures" class="col-3 items">
                <i class=" item-color far fa-receipt"></i>
                <p class="title-items">Factures</p>
            </a>
        </div>
    </div>
</div>
