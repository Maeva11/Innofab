        ...
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                ...
                <ul class="nav nav-tabs float-right">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= $_SERVER['REQUEST_URI'] ?>/set" ><i class="material-icons">code</i> Nouvelle machine</a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        foreach($data['datas'] as $el){?>
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    ...
                                    <a href="<?= $_SERVER['REQUEST_URI'] ?>/delete/<?= $el->id ?>" onclick="return confirm('�tes-vous de vouloir effectuer cette action ?')" class="btn btn-danger btn-link btn-lg"><i class="fas fa-times"></i></a>
                                </td>
                            </tr>
                        <?php }
                    }else{?>
