    ...
    <div style="height: 214px; padding-left: 15px; padding-right: 15px; opacity: 0.96; justify-content: space-between; align-items: flex-start; display: flex;">
        <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
            <div style="width: 471px; height: 148px; position: relative">
                <div style="width: 456px; height: 21px; left: 0px; top: 0px; position: absolute"><span
                            style="color: #EA581C; font-size: 14px; font-family: Roboto; font-weight: 700; line-height: 21px; word-wrap: break-word">Innofab</span><span
            ...
            <div style="width: 471px; height: 66px; position: relative">
                <div style="height: 18px; font-size:13px; padding-bottom: 1.49px; padding-right: 2.99px; left: 0px; top: 62%; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                   <i class="fa-regular fa-clock"></i>
                </div>
                <div style="width: 305.91px; height: 16px; left: 24px; top: 38px; position: absolute; color: #313030; font-size: 14px; font-family: Roboto; font-weight: 400; line-height: 21px; word-wrap: break-word">
        ...
        <div style="flex-direction: column; justify-content: flex-start; align-items: flex-end; gap: 60px; display: inline-flex">
            <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: flex">
                <div style="width: 132.07px; height: 21px; color: #EA581C; font-size: 14px; font-family: Roboto; font-weight: 700; line-height: 21px; word-wrap: break-word">
                    Contact
                </div>
                <div style="justify-content: flex-start; align-items: flex-end; gap: 10px; display: inline-flex">
                    <div style="width: 15px; height: 14.63px; font-size: 12px">
                        <i class="fas fa-phone"></i>
                    </div>
                    <div style="width: 100.14px; height: 16px; color: #1F2243; font-size: 14px; font-family: Roboto; font-weight: 400; line-height: 21px; word-wrap: break-word">
                ...
                <div style="justify-content: flex-start; align-items: center; gap: 10px; display: inline-flex">
                    ...
                    <div style="width: 207px; height: 16px; color: #1D2140; font-size: 14px; font-family: Roboto; font-weight: 400; line-height: 21px; word-wrap: break-word">
            ...
            <div style="width: 232px; height: 67px; position: relative">
                <div style="width: 228.45px; height: 21px; left: 3.55px; top: 0px; position: absolute; color: #EA581C; font-size: 14px; font-family: Roboto; font-weight: 700; line-height: 21px; word-wrap: break-word">
                    Réseaux Sociaux
                </div>
